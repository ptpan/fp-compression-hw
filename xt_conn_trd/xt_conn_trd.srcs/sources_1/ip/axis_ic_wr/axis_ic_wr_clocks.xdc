# Set max delays between M00_AXIS_ACLK and ACLK for async clock cross across fifo_generator instance
set clock_axis_aclk [get_clocks -of_objects [get_ports M00_AXIS_ACLK]]
...
set_false_path -through [get_nets -hier -filter {NAME =~ *axis_interconnect_0/inst_mi_datapath[0]*s_and_m_aresetn_i}]
