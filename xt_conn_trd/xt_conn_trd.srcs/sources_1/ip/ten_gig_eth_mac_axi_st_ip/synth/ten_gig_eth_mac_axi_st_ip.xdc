...
set_false_path -to [get_pins -filter {NAME =~ */CLR} -of_objects [get_cells {sync_resetn/reset_async*_reg}]]
...
### Statistics ###
# Cover the clock domain crossing into and out of the management clock domain.
...
set statsRxSlowGroup1 [get_cells -filter {is_sequential} -of [get_pins -leaf -of [get_nets -of_objects [get_pins ten_gig_eth_mac_axi_st_ip_core/xgmac_inst/G_MANAGEMENT.managen/G_STATS.stat/rx_clk_quarter_small_reg/Q]]]]
set statsRxSlowGroup2 [get_cells -filter {is_sequential} -of [get_pins -leaf -of [get_nets -of_objects [get_pins ten_gig_eth_mac_axi_st_ip_core/xgmac_inst/G_MANAGEMENT.managen/G_STATS.stat/rx_we_reg_reg/Q]]]]
set statsRxSlowGroup3 [get_cells -filter {is_sequential} -of [get_pins -leaf -of [get_nets -of_objects [get_pins ten_gig_eth_mac_axi_st_ip_core/xgmac_inst/G_MANAGEMENT.managen/G_STATS.stat/rx_carry_reset_reg_reg[*]/Q]]]]
...
set statsTxSlowGroup1 [get_cells -filter {is_sequential} -of [get_pins -leaf -of [get_nets -of_objects [get_pins ten_gig_eth_mac_axi_st_ip_core/xgmac_inst/G_MANAGEMENT.managen/G_STATS.stat/tx_clk_quarter_small_reg/Q]]]]
set statsTxSlowGroup2 [get_cells -filter {is_sequential} -of [get_pins -leaf -of [get_nets -of_objects [get_pins ten_gig_eth_mac_axi_st_ip_core/xgmac_inst/G_MANAGEMENT.managen/G_STATS.stat/tx_we_reg_reg/Q]]]]
set statsTxSlowGroup3 [get_cells -filter {is_sequential} -of [get_pins -leaf -of [get_nets -of_objects [get_pins ten_gig_eth_mac_axi_st_ip_core/xgmac_inst/G_MANAGEMENT.managen/G_STATS.stat/tx_carry_reset_reg_reg[*]/Q]]]]
...
set mdioEnCells [get_cells -of [get_pins -leaf -filter {is_enable} -of [get_nets -of_objects [get_pins ten_gig_eth_mac_axi_st_ip_core/xgmac_inst/G_MANAGEMENT.managen/mdio_master_i/mdc_ce_reg/Q]]]]
